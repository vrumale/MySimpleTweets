 ...
 */
public class FollowingListTimeline extends  UsersListFragment {
    ...
    public static FollowingListTimeline newInstance(String screen_name) {
        FollowingListTimeline userFragment = new FollowingListTimeline();
